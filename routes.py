...
from ipojucao.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
    ...
    if form_criarconta.validate_on_submit() and "botao_submit_criarconta" in request.form:
        ...
        if existing_user:
            ...
            try:
                ...
                flash('Erro de integridade ao criar a conta. Por favor, tente novamente.', 'alert-danger')
